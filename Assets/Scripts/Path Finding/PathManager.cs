...
[System.Serializable] public class PathConnection{
...
[System.Serializable] public class PathManager : SingletonObject<PathManager>{
    ...
    public void GetShortestPath(PathNode start, PathNode goal){
        ...
        while(openList.Count > 0){
            ...
            for(int i = 0; i < connections.Count; i++){
                ...
                if (ContainsNode(closedList, endNode)){
                    continue;
                }
